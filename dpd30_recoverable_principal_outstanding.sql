-- Code for extracting DPD30+ recoverable principal outstanding
...
select reference_date,     
    ...
    sum(case when A.loan_max_dpd_unpaid_lcl_days>30 then principal_outstanding_lcl_amt else 0 end) as dpd30_all,
  -- Recoverable DPD30+ Principal Outstanding as METRIC
