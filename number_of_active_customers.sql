-- customers with recoverable principal outstanding >0 are considered as active customers
select reference_date,     
    ...
    count(distinct(case when principal_outstanding_lcl_amt>0 and is_non_recoverable_flag=False then a.cmd_ctr_borrower_id else null end)) as metric
