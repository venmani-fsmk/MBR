-- Code for extracting DPD Rates at product level
...
select reference_date, 
    ...
    sum(case when is_non_recoverable_flag = False then principal_outstanding_lcl_amt else 0 end) + 1 as total_outstanding,
